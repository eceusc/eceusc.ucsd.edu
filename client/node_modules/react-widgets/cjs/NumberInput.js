...
class NumberPickerInput extends _react.default.Component {
  constructor(...args) {
    super(...args);
    this.state = {};
    this.input = /*#__PURE__*/(0, _react.createRef)();
  ...
  componentDidUpdate(_, __, {
    ...
    if (reselectText) (_this$input$current = this.input.current) == null ? void 0 : _this$input$current.select();
  ...
  isSelectingAllText() {
    const node = _canUseDOM.default && this.input.current;
    return !!node && (0, _activeElement.default)() === node && node.selectionStart === 0 && node.selectionEnd === node.value.length;
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Input.default, _extends({}, props, {
      ref: (0, _useMergedRefs.mergeRefs)(innerRef, this.input),
      inputMode: "numeric",
