...
function CommitteeItem(name: string, desc: string, redirect: string) {
    return (
        <>
            <div
                className="flex flex-col p-6 h-fit md:h-60 text-center rounded-lg bg-slate-700 shadow-lg"
            >
                <div className="flex flex-row justify-center">
                    <span className="text-2xl text-white p-2 font-bold">
                        {name}
                    </span>

                    <Link
                        href={redirect}
                        className="text-2xl text-white pt-3 font-bold"
                    >
                        <FaArrowRight />
                    </Link>
                </div>
                <span className="text-lg text-white p-2">
                    {desc}
                </span>
            </div>
        </>
