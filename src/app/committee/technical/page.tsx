...
export default function Social() {
  ...
  let button = [
    ["Apply", "https://forms.gle/1xR9AFFiPfJDY6Us6"]
  ]
  let images = [
  ...
  let files = ["/images/committees/technical/2023F_guided_qp.png", "https://drive.google.com/file/d/1e4MbFcUu_ifKBuET9UwVkdm_KgyZPs8O/preview"]
